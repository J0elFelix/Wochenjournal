...
##### Am Morgen habe ich am Carousel weitergearbeitet und um 09:00 Uhr war auch schon das Get-Together. Dort musste ich nur zuhören und danach war das Sprintplanning. Dort habe ich für den nächsten Sprint ein neues Ticket bekommen und danach habe ich mit dem Titel Task begonnen da dies Vorrang hat. Dies hat super funktioniert und habe dann einen PR erstellt und danach war es dann auch im Dev Branch. Daraufhin habe ich in den Engagement Dev Chat geschrieben für was die Content Width Variable ist denn diese wird anscheinend beim Carousel angezogen ohne das ich diese definiert habe. Somit kann auch das Problem beim Carousel gelöst werden und ich kann mit den Bug Tickets weiterfahren oder mit meinem anderen Ticket weitermachen wenn das Carousel fertig ist. Zwischendurch hatte ich noch das Daily mit Joel. Es wurde wegen dem Get-Together verschoben und weil das Team-Meeting ausfällt haben wir es gleich dann wenn eigentlich das Team-Meeting wäre. Ich habe dann Joel dort noch wegen dem Englisch C1 gefragt. 
---
## Dienstag:
